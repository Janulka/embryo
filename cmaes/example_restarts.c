...
int main(int argn, char **args)
{
	...
	const char *filename = "cmaes_initials.par"; /* input parameter file */
	FILE *fp = NULL;
...
double * optimize(double(*pFun)(double const *), int nrestarts, double incpopsize, const char * filename)
{
