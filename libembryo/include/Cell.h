...
//	  typedef PCellContainer::iterator PCellIterator;
  ...
  class Cell : public Object {
	public:
	  Cell(size_t inNbStates, size_t inNbChemicals, int inRow, int inColumn, int iSize, size_t iIndex, bool iLeftBorder, bool iRightBorder, bool iUpperBorder, bool iLowerBorder, double iValue);
          Cell(size_t inNbStates, size_t inNbChemicals, int inRow, int inColumn, int iSize, size_t iIndex, bool iLeftBorder, bool iRightBorder, bool iUpperBorder, bool iLowerBorder, const Cell * iCell);
	  ~Cell();
	  
	  void addNeighbor(int iDirection, int iSize);
...
//          bool clearNeighbors(Direction iDir);
          ...
          inline void changePositionX(int x) { mPositionX = x; }
          inline void changePositionY(int y) { mPositionY = y; }
          inline void multiSize(int iMulti) { mSize *= iMulti; }
          inline void decreasePositionY(int value) { mPositionY -= sqrt(value); }
          inline void decreasePositionX(int value) { mPositionX -= sqrt(value); }
	  void swapContent();
	  ...
	  void checkPositionX(int & ioSharedLength, int iPosx, int iSize);
	  void checkPositionY(int & ioSharedLength, int iPosY, int iSize);
